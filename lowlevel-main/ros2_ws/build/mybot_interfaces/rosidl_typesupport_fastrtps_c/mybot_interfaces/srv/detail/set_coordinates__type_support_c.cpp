...
#include "mybot_interfaces/srv/detail/set_coordinates__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_mybot_interfaces
...
using _SetCoordinates_Request__ros_msg_type = mybot_interfaces__srv__SetCoordinates_Request;
...
size_t get_serialized_size_mybot_interfaces__srv__SetCoordinates_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetCoordinates_Request__ros_msg_type * ros_message = static_cast<const _SetCoordinates_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetCoordinates_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mybot_interfaces__srv__SetCoordinates_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mybot_interfaces
size_t max_serialized_size_mybot_interfaces__srv__SetCoordinates_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mybot_interfaces__srv__SetCoordinates_Request;
    is_plain =
      (
...
static size_t _SetCoordinates_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mybot_interfaces__srv__SetCoordinates_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mybot_interfaces, srv, SetCoordinates_Request)() {
...
using _SetCoordinates_Response__ros_msg_type = mybot_interfaces__srv__SetCoordinates_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mybot_interfaces
size_t get_serialized_size_mybot_interfaces__srv__SetCoordinates_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetCoordinates_Response__ros_msg_type * ros_message = static_cast<const _SetCoordinates_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mybot_interfaces__srv__SetCoordinates_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mybot_interfaces
size_t max_serialized_size_mybot_interfaces__srv__SetCoordinates_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mybot_interfaces__srv__SetCoordinates_Response;
    is_plain =
      (
...
static size_t _SetCoordinates_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mybot_interfaces__srv__SetCoordinates_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mybot_interfaces, srv, SetCoordinates_Response)() {
...
// already included above
// #include "mybot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "mybot_interfaces/srv/set_coordinates.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mybot_interfaces, srv, SetCoordinates)() {
