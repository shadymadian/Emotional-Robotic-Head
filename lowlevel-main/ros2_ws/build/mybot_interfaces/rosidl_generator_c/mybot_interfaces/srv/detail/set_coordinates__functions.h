...
#ifndef MYBOT_INTERFACES__SRV__DETAIL__SET_COORDINATES__FUNCTIONS_H_
#define MYBOT_INTERFACES__SRV__DETAIL__SET_COORDINATES__FUNCTIONS_H_
 ...
 * calls
 * mybot_interfaces__srv__SetCoordinates_Request__init().
...
/**
 * It calls
 * mybot_interfaces__srv__SetCoordinates_Request__fini()
 ...
 * mybot_interfaces__srv__SetCoordinates_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mybot_interfaces__srv__SetCoordinates_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mybot_interfaces__srv__SetCoordinates_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mybot_interfaces
...
/**
 * It calls
 * mybot_interfaces__srv__SetCoordinates_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mybot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mybot_interfaces__srv__SetCoordinates_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mybot_interfaces
...
/**
 * It calls
 * mybot_interfaces__srv__SetCoordinates_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MYBOT_INTERFACES__SRV__DETAIL__SET_COORDINATES__FUNCTIONS_H_
