...
#include "mybot_interfaces/srv/detail/set_coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mybot_interfaces::srv::SetCoordinates_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mybot_interfaces::srv::SetCoordinates_Request & ros_message)
{
  // Member: coordinates
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mybot_interfaces::srv::SetCoordinates_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mybot_interfaces::srv::SetCoordinates_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mybot_interfaces::srv::SetCoordinates_Request *>(
    untyped_ros_message);
...
{
  return &mybot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoordinates_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mybot_interfaces, srv, SetCoordinates_Request)() {
  return &mybot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoordinates_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mybot_interfaces
cdr_serialize(
  const mybot_interfaces::srv::SetCoordinates_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mybot_interfaces::srv::SetCoordinates_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mybot_interfaces::srv::SetCoordinates_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mybot_interfaces::srv::SetCoordinates_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mybot_interfaces::srv::SetCoordinates_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mybot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoordinates_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mybot_interfaces, srv, SetCoordinates_Response)() {
  return &mybot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoordinates_Response__handle;
}
...
{
  return &mybot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoordinates__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mybot_interfaces, srv, SetCoordinates)() {
  return &mybot_interfaces::srv::typesupport_fastrtps_cpp::_SetCoordinates__handle;
}
